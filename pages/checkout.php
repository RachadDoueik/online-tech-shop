...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    extract($_POST);
    if (gettype($cartProducts) == 'array' && isset($governorate) && isset($street) && isset($address) && isset($building) && isset($contactNumber) && isset($city)) {
...
<head>
    ...
    <title>Tech Zone: Checkout Page</title>
...
<body class="sub_page">
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <i class="fa fa-user-o" aria-hidden="true"></i>
                                    ...
                                    echo ' <a href="login.php">
                      <img src=' . $user->profilePicture . ' alt="user" style="height: 1.5rem; width: 1.5rem; border-radius: 5rem; margin: 0.5rem 0 0.5rem 0;"/>
                    </a>';
                                }
                            } else {
                                echo ' <a href="login.php">
    ...
    <!--Invoices-->
    <?php
    if (gettype($cartProducts) != 'string' && !isset($_POST['ok'])) {
        echo '
    <div class="container">
        <div class="row">
                    ...
                    <form method="post">
                        <div class="row">
                            <div class="col">
                                ...
                                <input name="firstName" id="firstName" type="text" value="' . $user->firstName . '" readonly />
                            </div>
                            <div class="col">
                        ...
                        <div>
                            ...
                            <input name="contactNumber" id="contactNumber" type="text" placeholder="*Contact Number" value="' . $user->phoneNumber . '" required />
                        </div>
                        <div>
                            ...
                            <div>
                                <div class="input-group mb-3">
                                    ...
                                    <select class="custom-select" id="inputGroupSelect01" name="governorate">
                                        <option value="Beirout">Beirut</option>
                                        ...
                                        <option value="Baalback">Baalbeck</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <input name="building" required id="building" type="text" size="30" />
                        </div>
                        <div>
    ...
    ?>
    <button type="submit" name="ok" class="btn btn-primary btn-lg bg-primary border border-primary font-weight-bold">
        Confirm Order
    </button>'
    </div>
    </div>
